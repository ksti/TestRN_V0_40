...
export default class YuanXinWebView extends Component {
    ...
    onBridgeMessage(message) {
        if (this.props.onBridgeMessage)
            this.props.onBridgeMessage(message.nativeEvent.message);
    }
    /**
    ...
    reload() {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewHandle(),
            UIManager.YuanXinWebView.Commands.reload,
            null
        );
    }
    ...
    sendToBridge(value: string) {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewHandle(),
            UIManager.YuanXinWebView.Commands.sendToBridge,
            [value]
        );
    }
    ...
    _onBridgeMessage(event: Event) {
        ...
        this.props.onBridgeMessage(event.nativeEvent);
    }
}
