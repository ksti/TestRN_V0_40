...
import com.testrn_v0_40.MainApplication;
import com.testrn_v0_40.R;
    ...
    public void setMarker(MapView mapView, ReadableArray array) {
        ...
        if (array != null) {
            for (int i = 0; i < array.size(); i++) {
                ...
                //构建Marker图标
                BitmapDescriptor bitmap = BitmapDescriptorFactory.fromResource(R.drawable.ucrop_ic_angle);
